		...
		<>
			<div className="profile-container vh">
				...
				<div className="text-container">
					...
					<h3 className="artistLocation">
						{context.currentUser.location}
					</h3>
					<p className="artistBio">{context.currentUser.bio}</p>
				</div>
				...
				<div className="feature-description">
					...
					<p className="mando-description">
						Girl with a Mandolin is an early example of an Analytic
						Cubist painting. Picasso painted from a model who sat in
						front of him, facing him. You, as the viewer, are in the
						position of the artist. The model is a nude girl holding
						a mandolin. We see the upper part of her body, from her
						thighs to her head.
					</p>
				</div>
			</div>
