...
const CollectorSignUp = () => {
	...
	function handleFormSubmit(e) {
		...
		sendSubmissionInfo({
			...childInputs,
			username: childInputs.first_name + " " + childInputs.last_name,
		});
	}
			...
			<div className="gridParent">
				...
				>
					...
					<GridItem className="gridContent" colSpan={4}>
						DNDY is a trusted source for the finest art available.
						Pieces that are featured in our store immediately gain
						recognition in the community of collectors and artists.
						Every piece that we sell comes with a DNDY signed
					...
					<GridItem className="gridContent" colSpan={4}>
						...
						without you. That is why we treat our collectors with
						the utmost respect. Our staff responds promptly to
						questions and concerns. Customer satisfaction is our top
						priority.
					</GridItem>
					<GridItem className="gridTitle" colSpan={2}>
						Product Handling
					...
					<GridItem className="gridContent" colSpan={4}>
						You don't have to do a thing. Once you win the auction,
						our team will reach out immediately to arrange a product
						delivery plan that best suites you. And rest assured, we
